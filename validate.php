...
<span class="error">* required field.<?php echo $emailError;?></span>
Gender:
<input class="radio" name="gender" type="radio" value="female">Female
<input class="radio" name="gender" type="radio" value="male">Male
<span class="error">* required field.<?php echo $genderError;?></span>
Website:
<input class="input" name="website" type="text" value="">
<span class="error">* required field.<?php echo $websiteError;?></span>
Comment:
